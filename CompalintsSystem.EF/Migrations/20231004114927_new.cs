    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2023, 10, 4, 14, 49, 26, 328, DateTimeKind.Local).AddTicks(1873), "تلاعب بالحلول", null, "قيمة افتراضية من النضام" },
                    { 1, new DateTime(2023, 10, 4, 14, 49, 26, 328, DateTimeKind.Local).AddTicks(1851), "تماطل", null, "قيمة افتراضية من النضام" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 4, 14, 49, 26, 329, DateTimeKind.Local).AddTicks(117), "زراعية", null, "قيمة افتراضية من النضام" },
                    { 2, new DateTime(2023, 10, 4, 14, 49, 26, 329, DateTimeKind.Local).AddTicks(538), "فساد", null, "قيمة افتراضية من النضام" }
                });
