    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2022, 12, 6, 0, 10, 29, 973, DateTimeKind.Local).AddTicks(3726), "تلاعب بالحلول", null, "قيمة افتراضية من النضام" },
                    { 1, new DateTime(2022, 12, 6, 0, 10, 29, 973, DateTimeKind.Local).AddTicks(3712), "تماطل", null, "قيمة افتراضية من النضام" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 6, 0, 10, 29, 973, DateTimeKind.Local).AddTicks(9819), "زراعية", null, "قيمة افتراضية من النضام" },
                    { 2, new DateTime(2022, 12, 6, 0, 10, 29, 974, DateTimeKind.Local).AddTicks(175), "فساد", null, "قيمة افتراضية من النضام" }
                });
