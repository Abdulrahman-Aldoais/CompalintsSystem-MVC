    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2023, 11, 3, 22, 51, 28, 811, DateTimeKind.Local).AddTicks(3638), "تلاعب بالحلول", null, "قيمة افتراضية من النضام" },
                    { 1, new DateTime(2023, 11, 3, 22, 51, 28, 811, DateTimeKind.Local).AddTicks(3587), "تماطل", null, "قيمة افتراضية من النضام" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 3, 22, 51, 28, 812, DateTimeKind.Local).AddTicks(6314), "زراعية", null, "قيمة افتراضية من النضام" },
                    { 2, new DateTime(2023, 11, 3, 22, 51, 28, 812, DateTimeKind.Local).AddTicks(7031), "فساد", null, "قيمة افتراضية من النضام" }
                });
