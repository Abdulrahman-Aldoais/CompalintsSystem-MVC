    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, new DateTime(2023, 10, 6, 23, 20, 33, 976, DateTimeKind.Local).AddTicks(395), "تلاعب بالحلول", null, "قيمة افتراضية من النضام" },
                    { 1, new DateTime(2023, 10, 6, 23, 20, 33, 976, DateTimeKind.Local).AddTicks(324), "تماطل", null, "قيمة افتراضية من النضام" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 6, 23, 20, 33, 977, DateTimeKind.Local).AddTicks(5179), "زراعية", null, "قيمة افتراضية من النضام" },
                    { 2, new DateTime(2023, 10, 6, 23, 20, 33, 977, DateTimeKind.Local).AddTicks(5994), "فساد", null, "قيمة افتراضية من النضام" }
                });
